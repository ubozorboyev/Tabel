...
import net.city.tabel.adapters.WorkSettingAdapter
import net.city.tabel.databinding.PageTwoBinding
import net.city.tabel.dialogs.BaseInterface
import net.city.tabel.dialogs.ChoseItemDialog
import net.city.tabel.model.Lastadded
import net.city.tabel.utils.SharedPreferense
import net.city.tabel.viewmodel.pageviewmodels.PageTwoViewModel
    ...
    fun adapterListeners(){
        ...
        adapter.selectedListener = object:(Int)->Unit{
            ...
            override fun invoke(p1: Int) {
                ...
                val dialog= ChoseItemDialog(context!!,
                    obNames.toList().toTypedArray(),
